...
Adicionalmente, é relevante apontar que as pontuações do BERTScore de precisão e \textit{recall}, diferentemente de outras aplicações, somente tendem a ficar com valores muito próximos de 1 quando da correspondência exata das palavras da resposta gerada com as palavras da resposta desejada. Mesmo em casos de respostas corretas, geradas por atores humanos, é incrementalmente cais improvável a redação de uma resposta a uma pergunta com teor exatamente igual a um texto de referência, salvo em casos de citação direta.
