...
\begin{center}
	{
	\Large{
	    \textbf{Assistente de Busca: Uma abordagem RAG para busca semântica em documentos textuais da Alern}
	    }
	}
\end{center}
